...
module.exports = {
    '/ssoagentlogin': {
      changeOrigin: true,
      target: 'http://iamlimit.ops-activityeffect.51.env', //stable服务端地址
      headers:{
 ...
 //target: 'http://opsplate.u51-inc.com', //online服务端地址
  ...
  // target:'http://ops-activityeffect.st.51.nb:8080',
   ...
   // target:  process.env.BUILD_ENV === 'prod' ? 'http://opsplate.u51-inc.com' : 'http://ops-activityeffect.st.51.nb:8080', //
    target:  process.env.BUILD_ENV === 'prod' ? 'http://opsplate.u51-inc.com' : 'http://iamlimit.ops-activityeffect.51.env', //连线上
    },
